<section>
    <header>
        <h2 class="text-lg font-bold text-slate-900">Aggiorna password</h2>
        <p class="mt-1 text-sm text-slate-500">Assicurati di usare una password lunga e casuale per la sicurezza del tuo account.</p>
    </header>
